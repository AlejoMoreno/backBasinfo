...
class NoticesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create notice" do
    assert_difference('Notice.count') do
      post notices_url, params: { notice: { body: @notice.body, pageurl: @notice.pageurl, title: @notice.title } }, as: :json
    end
  ...
  test "should update notice" do
    patch notice_url(@notice), params: { notice: { body: @notice.body, pageurl: @notice.pageurl, title: @notice.title } }, as: :json
    assert_response 200
  end
